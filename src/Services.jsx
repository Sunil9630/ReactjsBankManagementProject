import img from './images/Thumb_ECS.png';
import img2 from './images/Thumb_AWB.png';
import img3 from './images/Thumb_Emaintenance.png';
const Services = () => {
    return (
        <>
            <h1 style={{textAlign:"center",color:"blue",margin:"30px"}}>SERVICES</h1>
            <p style={{marginLeft:"100px",fontWeight:"bold"}}>Federal Bank gives a whole new meaning to Banking with a host of value added services</p>
